...
public class PlayerAttacks : MonoBehaviour
{
    ...
    {
        if(Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) > -135 && Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) <= -45)
            playerAnimator.SetTrigger("Left");
        if(Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) > -45 && Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) <= 45)
            playerAnimator.SetTrigger("Up");
        if(Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) > 45 && Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) <= 135)
            playerAnimator.SetTrigger("Right");
        if(Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) > 135 || Vector3.SignedAngle(Vector3.forward, GetDirectionTowardsMouse(), Vector3.up) < -135)
